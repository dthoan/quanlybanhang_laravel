...
<div class="col-lg-12 m-t-100">
    <div class="card">
        ...
        <div class="card-body card-block">
            <form @if ($isEdit) action="{{  route('edit_product', $product->id)}}" @endif method="POST" enctype='multipart/form-data'>
                {{csrf_field()}}
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select class="form-control" name="id_type">
                                    ...
                                    <option class="form-control" @if ($product -> id_type == $cate_option->id)
                                        selected="selected"
                                        @endif
