                            ...
                            <table class="table mb-0">
                                ...
                                <tr>
                                    ...
                                    <td class="product-image-title">
                                        <a href="#" class="image"><img src="image\products\product-1.jpg" alt="Compare Product"></a>
                                        <a href="#" class="category">Glasses</a>
                                        <a href="#" class="title">Rinosin Glasses</a>
                                    </td>
                                    <td class="product-image-title">
                                        <a href="#" class="image"><img src="image\products\product-2.jpg" alt="Compare Product"></a>
                                        <a href="#" class="category">Glasses</a>
                                        <a href="#" class="title">Macro Melodi</a>
                                    </td>
                                    <td class="product-image-title">
                                        <a href="#" class="image"><img src="image\products\product-3.jpg" alt="Compare Product"></a>
                                        <a href="#" class="category">Glasses</a>
                                ...
                                <tr>
                                    ...
                                    <td class="pro-addtocart"><a href="#" class="add-to-cart" tabindex="0"><i class="fas fa-shopping-cart"></i><span>ADD TO CART</span></a>
                                    </td>
                                    <td class="pro-addtocart"><a href="#" class="add-to-cart" tabindex="0"><i class="fas fa-shopping-cart"></i><span>ADD TO CART</span></a>
                                    </td>
                                    <td class="pro-addtocart"><a href="#" class="add-to-cart" tabindex="0"><i class="fas fa-shopping-cart"></i><span>ADD TO CART</span></a>
